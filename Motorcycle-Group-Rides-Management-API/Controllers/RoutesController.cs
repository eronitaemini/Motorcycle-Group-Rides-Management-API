...
namespace Motorcycle_Group_Rides_Management_API.Controllers
{
	...
	public class RoutesController : ControllerBase
	{
        ...
        [HttpGet("search")]
        public async Task<ActionResult> GetRoutes(string searchQuery = "", string sortBy = "StartingPoint", bool ascending = true, int pageNumber = 1, int pageSize = 10)
        {
            var routes = await _routeService.GetRoutesAsync(searchQuery, sortBy, ascending, pageNumber, pageSize);
            return Ok(routes);
        }
